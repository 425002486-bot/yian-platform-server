...
import cn.iocoder.yudao.framework.web.config.YianWebAutoConfiguration;
...
@AutoConfiguration(after = YianWebAutoConfiguration.class)
public class YianApiLogAutoConfiguration implements WebMvcConfigurer {
