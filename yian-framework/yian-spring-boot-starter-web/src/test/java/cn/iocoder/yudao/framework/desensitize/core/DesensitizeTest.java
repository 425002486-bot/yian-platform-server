...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("翼安智链");
        ...
        desensitizeDemo.setRegex("你好，我是翼安智链");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("翼安智链");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "翼安智链", replacer = "*")
