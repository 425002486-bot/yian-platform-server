 ...
 *      1）Spring Async：
 *          {@link cn.iocoder.yudao.framework.quartz.config.YianAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 YianSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
