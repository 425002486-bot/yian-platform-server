...
import cn.iocoder.yudao.framework.mq.redis.config.YianRedisMQConsumerAutoConfiguration;
 ...
 * @author xingyu4j
 */
@AutoConfiguration(before = YianRedisMQConsumerAutoConfiguration.class) // before YianRedisMQConsumerAutoConfiguration 的原因是，需要保证 RedisWebSocketMessageConsumer 先创建，才能创建 RedisMessageListenerContainer
...
public class YianWebSocketAutoConfiguration {
