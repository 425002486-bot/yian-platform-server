...
public class IotMessageBusAutoConfiguration {
    ...
    /**
     * 特殊：由于 YianRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see cn.iocoder.yudao.framework.mq.redis.config.YianRedisMQConsumerAutoConfiguration
     */
    @Configuration
