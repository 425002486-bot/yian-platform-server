...
import cn.iocoder.yudao.module.ai.framework.ai.config.YianAiProperties;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            YianAiProperties.Midjourney properties = SpringUtil.getBean(YianAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(YianAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        YianAiProperties.DouBao properties = new YianAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(YianAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        YianAiProperties.HunYuan properties = new YianAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(YianAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        YianAiProperties.SiliconFlow properties = new YianAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(YianAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        YianAiProperties.XingHuo properties = new YianAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(YianAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        YianAiProperties.BaiChuan properties = new YianAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(YianAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        YianAiProperties.Gemini properties = SpringUtil.getBean(YianAiProperties.class)
    ...
    private ChatModel buildGrokChatModel(String apiKey,String url) {
        YianAiProperties.Grok properties = new YianAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
