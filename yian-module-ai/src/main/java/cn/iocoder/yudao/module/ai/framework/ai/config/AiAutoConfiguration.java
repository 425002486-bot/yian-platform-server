 ...
 */
@Configuration
@EnableConfigurationProperties({ YianAiProperties.class,
...
public class AiAutoConfiguration {
    ...
    public GeminiChatModel geminiChatModel(YianAiProperties yianAiProperties) {
        YianAiProperties.Gemini properties = yianAiProperties.getGemini();
        return buildGeminiChatClient(properties);
    }

    public GeminiChatModel buildGeminiChatClient(YianAiProperties.Gemini properties) {
    ...
    public DouBaoChatModel douBaoChatClient(YianAiProperties yianAiProperties) {
        YianAiProperties.DouBao properties = yianAiProperties.getDoubao();
        return buildDouBaoChatClient(properties);
    }

    public DouBaoChatModel buildDouBaoChatClient(YianAiProperties.DouBao properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public SiliconFlowChatModel siliconFlowChatClient(YianAiProperties yianAiProperties) {
        YianAiProperties.SiliconFlow properties = yianAiProperties.getSiliconflow();
        return buildSiliconFlowChatClient(properties);
    }

    public SiliconFlowChatModel buildSiliconFlowChatClient(YianAiProperties.SiliconFlow properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public HunYuanChatModel hunYuanChatClient(YianAiProperties yianAiProperties) {
        YianAiProperties.HunYuan properties = yianAiProperties.getHunyuan();
        return buildHunYuanChatClient(properties);
    }

    public HunYuanChatModel buildHunYuanChatClient(YianAiProperties.HunYuan properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public XingHuoChatModel xingHuoChatClient(YianAiProperties yianAiProperties) {
        YianAiProperties.XingHuo properties = yianAiProperties.getXinghuo();
        return buildXingHuoChatClient(properties);
    }

    public XingHuoChatModel buildXingHuoChatClient(YianAiProperties.XingHuo properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public BaiChuanChatModel baiChuanChatClient(YianAiProperties yianAiProperties) {
        YianAiProperties.BaiChuan properties = yianAiProperties.getBaichuan();
        return buildBaiChuanChatClient(properties);
    }

    public BaiChuanChatModel buildBaiChuanChatClient(YianAiProperties.BaiChuan properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public MidjourneyApi midjourneyApi(YianAiProperties yianAiProperties) {
        YianAiProperties.Midjourney config = yianAiProperties.getMidjourney();
        return new MidjourneyApi(config.getBaseUrl(), config.getApiKey(), config.getNotifyUrl());
    }

    @Bean
    @ConditionalOnProperty(value = "yudao.ai.suno.enable", havingValue = "true")
    public SunoApi sunoApi(YianAiProperties yianAiProperties) {
        return new SunoApi(yianAiProperties.getSuno().getBaseUrl());
    }

    public ChatModel buildGrokChatClient(YianAiProperties.Grok properties) {
        if (StrUtil.isEmpty(properties.getModel())) {
    ...
    public AiWebSearchClient webSearchClient(YianAiProperties yianAiProperties) {
        return new AiBoChaWebSearchClient(yianAiProperties.getWebSearch().getApiKey());
    }
